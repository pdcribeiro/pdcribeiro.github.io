import ClickAndHoldManager from '/lib/ui/click-and-hold-manager.js'
import ItemSelectionManager from '/lib/ui/item-selection-manager.js'
import { stl } from '/lib/ui/utils.js'
import DragAndDropManager from '/lib/ui/web-drag-and-drop-manager.js'
import ScrollManager from '/lib/ui/web-scroll-manager.js'
...
export default function DragAndDropListManager({ items: rawItems, onSelect, onDeselect, onDrop }) {
