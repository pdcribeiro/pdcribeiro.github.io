...
import { WebDragAndDropManager } from '/lib/ui/web-drag-and-drop-manager.js'
import { WebScrollManager } from '/lib/ui/web-scroll-manager.js'
...
export function DragAndDropList({ items: rawItems, onSelect, onDeselect, onDrop }) {
    ...
    const dragAndDrop = new WebDragAndDropManager({
        placeholder: hr(),
    ...
    const scroll = new WebScrollManager()
