...
// FIX nested not working. remove anchor and elements on unmount (triggered by parent). idea: van.update not switching the node. idea: use custom element with lifecycle hooks
