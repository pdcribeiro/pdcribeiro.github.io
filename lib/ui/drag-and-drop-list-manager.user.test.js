// Browser tests for the DragAndDropListManager component

import { browserTest } from '/lib/test/runner.js'
import { visit } from '/lib/test/ui-helpers.js'
import DragAndDropListManager from '/lib/ui/drag-and-drop-list-manager.js'
...
function dragAndDrop(index, position, newIndex, page) {
    ...
    return page
        ...
        .wait(600)
        .root()
        .find('', { selector: `li:nth-child(${newIndex + 1})` })
        .emit('pointerenter')
        .root()
...
export function TestDragAndDropList() {
    ...
    const listManager = new DragAndDropListManager({
